...
public class IntentIntegrator {
     ...
     */
    public final void initiateScan(int requestCode) {
        startActivityForResult(createScanIntent(), requestCode);
    }
    public final void myInitiateScan(int requestCode,Fragment fragment) {
        myStartActivityForResult(createScanIntent(), requestCode,fragment);
    }
    ...
    protected void myStartActivityForResult(Intent intent, int code,Fragment fragment) {
        fragment.startActivityForResult(intent, code);
    }
