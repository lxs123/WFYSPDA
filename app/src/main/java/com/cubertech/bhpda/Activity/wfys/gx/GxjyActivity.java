package com.cubertech.bhpda.Activity.wfys.gx;
...
import com.cubertech.bhpda.Activity.wfys.dhys.DhysDetailActivity;
...
public class GxjyActivity extends AppCompatActivity {
    @BindView(R.id.et_tm)
    EditText etTm;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gxjy);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_SEND || actionId == EditorInfo.IME_ACTION_DONE || (event != null
                    ...
                    if (Double.parseDouble(etBfsl.getText().toString()) > 0) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(GxjyActivity.this, R.style.MP_Theme_alertDialog);
                        builder.setTitle("不良原因");
                        builder.setPositiveButton("确定", null);
                        builder.setNegativeButton("取消", null);
                        AlertDialog alertDialog = builder.create();
                        View view1 = LayoutInflater.from(GxjyActivity.this).inflate(R.layout.dialog_edit_dhys_bhgsl, null);
    ...
    private void onScanResult() {
        ...
        su.callService(GxjyActivity.this, link, params, true, new ServiceUtils.ServiceCallBack() {
            @Override
            ...
            public void onFailure(String str) {
                CommonUtil.showErrorDialog(GxjyActivity.this, str);
            ...
            public void onError(String error) {
                Toast.makeText(GxjyActivity.this, error, Toast.LENGTH_LONG).show();
                su.closeParentDialog();//必须
                etTm.setText("");
                etTm.setSelection(0);
                etTm.requestFocus();
    ...
    private void onUrlLoad() {
        ...
        SharedPreferences sp = GxjyActivity.this.getSharedPreferences(
...
//        Log.e("#####", objectList.toString());
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(GxjyActivity.this, R.style.MP_Theme_alertDialog);
